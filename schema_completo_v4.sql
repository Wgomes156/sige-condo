...
DROP POLICY IF EXISTS "Usuarios podem ver categorias" ON categorias_financeiras;
DROP POLICY IF EXISTS "Usuarios podem ver boletos" ON boletos;
DROP POLICY IF EXISTS "Usuarios podem criar boletos" ON boletos;
DROP POLICY IF EXISTS "Usuarios podem atualizar boletos" ON boletos;
DROP POLICY IF EXISTS "Admins podem deletar boletos" ON boletos;
DROP POLICY IF EXISTS "Usuarios podem ver transacoes" ON transacoes_financeiras;
DROP POLICY IF EXISTS "Usuarios podem criar transacoes" ON transacoes_financeiras;
DROP POLICY IF EXISTS "Usuarios podem atualizar transacoes" ON transacoes_financeiras;
DROP POLICY IF EXISTS "Admins podem deletar transacoes" ON transacoes_financeiras;
...
DROP POLICY IF EXISTS "Admins podem gerenciar acessos condomínio" ON public.user_condominio_access;
DROP POLICY IF EXISTS "Usuários podem ver seus próprios acessos" ON public.user_condominio_access;
...
DROP POLICY IF EXISTS "Visualizar condominios permitidos" ON public.condominios;
DROP POLICY IF EXISTS "Admins podem criar condominios" ON public.condominios;
DROP POLICY IF EXISTS "Gerenciar condominios permitidos" ON public.condominios;
DROP POLICY IF EXISTS "Admins podem deletar condominios" ON public.condominios;
DROP POLICY IF EXISTS "Visualizar unidades permitidas" ON public.unidades;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar unidades" ON public.unidades;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar unidades" ON public.unidades;
DROP POLICY IF EXISTS "Admins podem deletar unidades" ON public.unidades;
DROP POLICY IF EXISTS "Visualizar OS permitidas" ON public.ordens_servico;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar OS" ON public.ordens_servico;
...
DROP POLICY IF EXISTS "Admin e Gerentes podem criar boletos" ON public.boletos;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar boletos" ON public.boletos;
DROP POLICY IF EXISTS "Admin pode deletar boletos" ON public.boletos;
DROP POLICY IF EXISTS "Visualizar transacoes permitidas" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar transacoes" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar transacoes" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Admin pode deletar transacoes" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Visualizar atendimentos permitidos" ON public.atendimentos;
DROP POLICY IF EXISTS "Admin, Gerentes e Operadores podem criar atendimentos" ON public.atendimentos;
DROP POLICY IF EXISTS "Gerenciar atendimentos permitidos" ON public.atendimentos;
DROP POLICY IF EXISTS "Admin pode deletar atendimentos" ON public.atendimentos;
DROP POLICY IF EXISTS "Visualizar moradores permitidos" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar moradores" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar moradores" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Admin pode deletar moradores" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Visualizar veiculos permitidos" ON public.veiculos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar veiculos" ON public.veiculos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar veiculos" ON public.veiculos_unidade;
DROP POLICY IF EXISTS "Admin pode deletar veiculos" ON public.veiculos_unidade;
DROP POLICY IF EXISTS "Visualizar vagas permitidas" ON public.vagas_garagem;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar vagas" ON public.vagas_garagem;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar vagas" ON public.vagas_garagem;
DROP POLICY IF EXISTS "Admin pode deletar vagas" ON public.vagas_garagem;
DROP POLICY IF EXISTS "Visualizar animais permitidos" ON public.animais_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar animais" ON public.animais_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar animais" ON public.animais_unidade;
DROP POLICY IF EXISTS "Admin pode deletar animais" ON public.animais_unidade;
DROP POLICY IF EXISTS "Visualizar visitantes permitidos" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar visitantes" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar visitantes" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Admin pode deletar visitantes" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Visualizar acessos permitidos" ON public.acessos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar acessos" ON public.acessos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar acessos" ON public.acessos_unidade;
DROP POLICY IF EXISTS "Admin pode deletar acessos" ON public.acessos_unidade;
DROP POLICY IF EXISTS "Visualizar proprietarios permitidos" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar proprietarios" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar proprietarios" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Admin pode deletar proprietarios" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Visualizar inquilinos permitidos" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar inquilinos" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar inquilinos" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Admin pode deletar inquilinos" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Visualizar documentos permitidos" ON public.documentos_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar documentos" ON public.documentos_unidade;
DROP POLICY IF EXISTS "Admin pode deletar documentos" ON public.documentos_unidade;
DROP POLICY IF EXISTS "Visualizar ocorrencias permitidas" ON public.ocorrencias_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar ocorrencias" ON public.ocorrencias_unidade;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar ocorrencias" ON public.ocorrencias_unidade;
DROP POLICY IF EXISTS "Admin pode deletar ocorrencias" ON public.ocorrencias_unidade;
DROP POLICY IF EXISTS "Visualizar configuracoes permitidas" ON public.configuracoes_cobranca;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar configuracoes" ON public.configuracoes_cobranca;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar configuracoes" ON public.configuracoes_cobranca;
DROP POLICY IF EXISTS "Visualizar historico permitido" ON public.historico_geracao_boletos;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar historico" ON public.historico_geracao_boletos;
DROP POLICY IF EXISTS "Visualizar anexos autenticados" ON public.anexos;
DROP POLICY IF EXISTS "Criar anexos autenticados" ON public.anexos;
...
DROP POLICY IF EXISTS "Admin pode criar categorias" ON public.categorias_financeiras;
DROP POLICY IF EXISTS "Admin pode atualizar categorias" ON public.categorias_financeiras;
DROP POLICY IF EXISTS "Admin pode deletar categorias" ON public.categorias_financeiras;
DROP POLICY IF EXISTS "Visualizar administradoras" ON public.administradoras;
DROP POLICY IF EXISTS "Admin pode criar administradoras" ON public.administradoras;
DROP POLICY IF EXISTS "Admin pode atualizar administradoras" ON public.administradoras;
DROP POLICY IF EXISTS "Admin pode deletar administradoras" ON public.administradoras;
DROP POLICY IF EXISTS "Admins e gerentes podem gerenciar comunicados" ON public.comunicados;
DROP POLICY IF EXISTS "Moradores podem ver comunicados do seu condomínio" ON public.comunicados;
DROP POLICY IF EXISTS "Admins podem ver todos os perfis" ON public.profiles;
DROP POLICY IF EXISTS "Admins podem atualizar perfis" ON public.profiles;
DROP POLICY IF EXISTS "Moradores podem ver seus próprios acessos" ON public.user_unidade_access;
DROP POLICY IF EXISTS "Admins podem ver acessos unidade" ON public.user_unidade_access;
DROP POLICY IF EXISTS "Admins podem gerenciar acessos unidade" ON public.user_unidade_access;
DROP POLICY IF EXISTS "Gerentes podem ver acessos unidade do seu condomínio" ON public.user_unidade_access;
DROP POLICY IF EXISTS "Gerentes podem gerenciar acessos unidade do seu condomínio" ON public.user_unidade_access;
DROP POLICY IF EXISTS "Gerentes podem atualizar acessos unidade do seu condomínio" ON public.user_unidade_access;
DROP POLICY IF EXISTS "Gerentes podem remover acessos unidade do seu condomínio" ON public.user_unidade_access;
...
DROP POLICY IF EXISTS "Admins can view all administradoras" ON public.administradoras;
DROP POLICY IF EXISTS "Managers can view linked administradoras" ON public.administradoras;
DROP POLICY IF EXISTS "Admins can view all atendimentos" ON public.atendimentos;
DROP POLICY IF EXISTS "Managers can view condominium atendimentos" ON public.atendimentos;
DROP POLICY IF EXISTS "Operators see assigned atendimentos" ON public.atendimentos;
DROP POLICY IF EXISTS "Admins can view all boletos" ON public.boletos;
DROP POLICY IF EXISTS "Managers can view condominium boletos" ON public.boletos;
DROP POLICY IF EXISTS "Residents see own unit boletos" ON public.boletos;
DROP POLICY IF EXISTS "Admins can view all condominios" ON public.condominios;
DROP POLICY IF EXISTS "Managers can view assigned condominios" ON public.condominios;
DROP POLICY IF EXISTS "Residents can view own condominium basic info" ON public.condominios;
DROP POLICY IF EXISTS "Admins can view all unidades" ON public.unidades;
DROP POLICY IF EXISTS "Managers can view condominium unidades" ON public.unidades;
DROP POLICY IF EXISTS "Residents see own unit only" ON public.unidades;
DROP POLICY IF EXISTS "Admins can view all proprietarios" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Managers can view condominium proprietarios" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Unit users see own proprietario" ON public.proprietarios_unidade;
DROP POLICY IF EXISTS "Admins can view all inquilinos" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Managers can view condominium inquilinos" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Unit users see own inquilino" ON public.inquilinos_unidade;
DROP POLICY IF EXISTS "Admins can view all moradores" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Managers can view condominium moradores" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Unit users see own moradores" ON public.moradores_unidade;
DROP POLICY IF EXISTS "Admins can view all transacoes" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Managers can view condominium transacoes" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Residents see own unit transacoes" ON public.transacoes_financeiras;
DROP POLICY IF EXISTS "Admins can view all visitantes" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Managers can view condominium visitantes" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Unit users see own visitantes" ON public.visitantes_autorizados;
DROP POLICY IF EXISTS "Admins can view all anexos" ON public.anexos;
DROP POLICY IF EXISTS "Users can view accessible anexos" ON public.anexos;
DROP POLICY IF EXISTS "Admins can view categorias" ON public.categorias_financeiras;
DROP POLICY IF EXISTS "Managers can view categorias" ON public.categorias_financeiras;
DROP POLICY IF EXISTS "Only admins can view audit logs" ON public.audit_logs;
DROP POLICY IF EXISTS "Authenticated users can create audit logs" ON public.audit_logs;
DROP POLICY IF EXISTS "Admin full access to contas_bancarias" ON public.contas_bancarias;
DROP POLICY IF EXISTS "Gerente can view relevant contas_bancarias" ON public.contas_bancarias;
DROP POLICY IF EXISTS "Admin pode gerenciar todas ocorrências" ON public.ocorrencias_condominio;
DROP POLICY IF EXISTS "Gerente pode gerenciar ocorrências dos seus condomínios" ON public.ocorrencias_condominio;
DROP POLICY IF EXISTS "Operador pode visualizar ocorrências dos condomínios" ON public.ocorrencias_condominio;
...
DROP POLICY IF EXISTS "Categorias visíveis para autenticados" ON public.categorias_demanda;
DROP POLICY IF EXISTS "Admin pode gerenciar categorias" ON public.categorias_demanda;
DROP POLICY IF EXISTS "Templates visíveis para autenticados" ON public.templates_demanda;
DROP POLICY IF EXISTS "Admin pode gerenciar templates" ON public.templates_demanda;
DROP POLICY IF EXISTS "Fornecedores visíveis para autenticados" ON public.fornecedores;
DROP POLICY IF EXISTS "Admin e Gerentes podem gerenciar fornecedores" ON public.fornecedores;
DROP POLICY IF EXISTS "Visualizar demandas do condomínio" ON public.demandas_condominio;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar demandas" ON public.demandas_condominio;
DROP POLICY IF EXISTS "Admin e Gerentes podem atualizar demandas" ON public.demandas_condominio;
DROP POLICY IF EXISTS "Admin pode deletar demandas" ON public.demandas_condominio;
DROP POLICY IF EXISTS "Visualizar execuções permitidas" ON public.execucoes_demanda;
DROP POLICY IF EXISTS "Admin e Gerentes podem criar execuções" ON public.execucoes_demanda;
DROP POLICY IF EXISTS "Admin pode deletar execuções" ON public.execucoes_demanda;
DROP POLICY IF EXISTS "Visualizar config demandas" ON public.configuracoes_demanda;
DROP POLICY IF EXISTS "Admin e Gerentes podem gerenciar config" ON public.configuracoes_demanda;
DROP POLICY IF EXISTS "Categorias visíveis para autenticados" ON public.categorias_servico;
DROP POLICY IF EXISTS "Admin pode gerenciar categorias" ON public.categorias_servico;
DROP POLICY IF EXISTS "Serviços visíveis para autenticados" ON public.servicos;
DROP POLICY IF EXISTS "Admin pode gerenciar serviços" ON public.servicos;
DROP POLICY IF EXISTS "Histórico visível para admin" ON public.servicos_historico;
DROP POLICY IF EXISTS "Histórico criável por autenticados" ON public.servicos_historico;
DROP POLICY IF EXISTS "Admin pode gerenciar todas propostas" ON public.propostas;
DROP POLICY IF EXISTS "Gerente pode gerenciar propostas" ON public.propostas;
DROP POLICY IF EXISTS "Usuário pode ver suas próprias propostas" ON public.propostas;
DROP POLICY IF EXISTS "Usuário pode criar propostas" ON public.propostas;
DROP POLICY IF EXISTS "Usuário pode editar suas propostas em rascunho" ON public.propostas;
DROP POLICY IF EXISTS "Acesso a serviços da proposta" ON public.proposta_servicos;
DROP POLICY IF EXISTS "Acesso a documentos da proposta" ON public.proposta_documentos;
DROP POLICY IF EXISTS "Visualizar histórico da proposta" ON public.proposta_historico;
DROP POLICY IF EXISTS "Criar histórico da proposta" ON public.proposta_historico;
DROP POLICY IF EXISTS "Acesso a assinaturas da proposta" ON public.proposta_assinaturas;
DROP POLICY IF EXISTS "Admin pode gerenciar todos os acordos" ON public.acordos;
DROP POLICY IF EXISTS "Gerente pode gerenciar acordos do seu condomínio" ON public.acordos;
DROP POLICY IF EXISTS "Operador pode visualizar acordos atribuídos" ON public.acordos;
DROP POLICY IF EXISTS "Visualizar parcelas origem permitidas" ON public.acordo_parcelas_origem;
DROP POLICY IF EXISTS "Criar parcelas origem permitidas" ON public.acordo_parcelas_origem;
DROP POLICY IF EXISTS "Visualizar parcelas negociadas permitidas" ON public.acordo_parcelas_negociadas;
DROP POLICY IF EXISTS "Gerenciar parcelas negociadas permitidas" ON public.acordo_parcelas_negociadas;
DROP POLICY IF EXISTS "Visualizar histórico permitido" ON public.acordo_historico;
DROP POLICY IF EXISTS "Criar histórico permitido" ON public.acordo_historico;
DROP POLICY IF EXISTS "Admin pode gerenciar todos alertas" ON public.acordo_alertas;
DROP POLICY IF EXISTS "Visualizar alertas permitidos" ON public.acordo_alertas;
DROP POLICY IF EXISTS "Criar alertas permitidos" ON public.acordo_alertas;
DROP POLICY IF EXISTS "Atualizar alertas próprios" ON public.acordo_alertas;
DROP POLICY IF EXISTS "Residents see own unit boletos" ON public.boletos;
DROP POLICY IF EXISTS "Visualizar boletos permitidos" ON public.boletos;
DROP POLICY IF EXISTS "Admin pode gerenciar areas_comuns" ON public.areas_comuns;
DROP POLICY IF EXISTS "Gerente pode gerenciar areas do seu condomínio" ON public.areas_comuns;
DROP POLICY IF EXISTS "Moradores podem ver areas do seu condomínio" ON public.areas_comuns;
DROP POLICY IF EXISTS "Admin pode gerenciar todas reservas" ON public.reservas;
DROP POLICY IF EXISTS "Gerente pode gerenciar reservas do condomínio" ON public.reservas;
DROP POLICY IF EXISTS "Morador pode ver suas reservas" ON public.reservas;
DROP POLICY IF EXISTS "Morador pode criar reserva na sua unidade" ON public.reservas;
DROP POLICY IF EXISTS "Morador pode cancelar sua reserva" ON public.reservas;
DROP POLICY IF EXISTS "Admin pode gerenciar convidados" ON public.reserva_convidados;
DROP POLICY IF EXISTS "Acesso convidados via reserva" ON public.reserva_convidados;
DROP POLICY IF EXISTS "Criar historico autenticado" ON public.reserva_historico;
DROP POLICY IF EXISTS "Ver historico da reserva" ON public.reserva_historico;
...
DROP POLICY IF EXISTS "Authenticated users can view atendimento_historico" ON public.atendimento_historico;
DROP POLICY IF EXISTS "Authenticated users can insert atendimento_historico" ON public.atendimento_historico;
DROP POLICY IF EXISTS "Authenticated users can update atendimento_historico" ON public.atendimento_historico;
DROP POLICY IF EXISTS "Authenticated users can delete atendimento_historico" ON public.atendimento_historico;
...
DROP POLICY IF EXISTS "mensageria_config_staff" ON mensageria_config;
DROP POLICY IF EXISTS "mensageria_entregas_staff" ON mensageria_entregas;
DROP POLICY IF EXISTS "mensageria_entregas_morador" ON mensageria_entregas;
DROP POLICY IF EXISTS "mensageria_logs_staff" ON mensageria_logs;
DROP POLICY IF EXISTS "preferencias_proprio_morador" ON morador_preferencias_notificacao;
DROP POLICY IF EXISTS "preferencias_staff_view" ON morador_preferencias_notificacao;
