...
CREATE INDEX IF NOT EXISTS idx_atendimentos_data ON public.atendimentos(data DESC);
...
CREATE INDEX IF NOT EXISTS idx_transacoes_data ON public.transacoes_financeiras(data DESC);
CREATE INDEX IF NOT EXISTS idx_transacoes_tipo ON public.transacoes_financeiras(tipo_transacao);
