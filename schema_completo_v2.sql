...
-- Enum para roles
CREATE TYPE IF NOT EXISTS public.app_role AS ENUM ('admin', 'operador');
...
CREATE INDEX IF NOT EXISTS idx_boletos_condominio ON boletos(condominio_id);
...
CREATE INDEX IF NOT EXISTS idx_boletos_unidade ON boletos(unidade);
...
-- Índices para performance
CREATE INDEX IF NOT EXISTS idx_transacoes_condominio ON transacoes_financeiras(condominio_id);
...
CREATE TABLE IF NOT EXISTS public.historico_geracao_boletos (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  condominio_id UUID NOT NULL REFERENCES public.condominios(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_configuracoes_cobranca_ativa ON public.configuracoes_cobranca(ativa);
CREATE INDEX IF NOT EXISTS idx_historico_geracao_condominio ON public.historico_geracao_boletos(condominio_id);
...
CREATE TYPE IF NOT EXISTS public.os_status AS ENUM ('aberta', 'em_andamento', 'concluida', 'cancelada');

-- Criar enum para prioridade da OS
CREATE TYPE IF NOT EXISTS public.os_prioridade AS ENUM ('urgente', 'periodico', 'nao_urgente');
...
CREATE INDEX IF NOT EXISTS idx_ordens_servico_condominio ON public.ordens_servico(condominio_id);
CREATE INDEX IF NOT EXISTS idx_ordens_servico_data_solicitacao ON public.ordens_servico(data_solicitacao);-- Criar bucket para armazenamento de anexos
...
CREATE INDEX IF NOT EXISTS idx_anexos_entidade ON public.anexos(entidade_tipo, entidade_id);-- Adicionar campo numero na tabela condominios
...
CREATE TYPE IF NOT EXISTS public.tipo_unidade AS ENUM ('apartamento', 'casa', 'loja', 'escritorio', 'sala');
CREATE TYPE IF NOT EXISTS public.tipo_localizacao AS ENUM ('bloco', 'torre', 'rua');
CREATE TYPE IF NOT EXISTS public.situacao_unidade AS ENUM ('ativa', 'inativa', 'em_reforma', 'desocupada');
CREATE TYPE IF NOT EXISTS public.tipo_ocupacao AS ENUM ('moradia', 'aluguel', 'aluguel_temporada', 'desocupado');
CREATE TYPE IF NOT EXISTS public.responsavel_financeiro AS ENUM ('proprietario', 'inquilino');
CREATE TYPE IF NOT EXISTS public.status_financeiro_unidade AS ENUM ('em_dia', 'inadimplente', 'acordo');
CREATE TYPE IF NOT EXISTS public.tipo_veiculo AS ENUM ('carro', 'moto', 'bicicleta', 'outro');
CREATE TYPE IF NOT EXISTS public.porte_animal AS ENUM ('pequeno', 'medio', 'grande');
...
CREATE TABLE IF NOT EXISTS public.proprietarios_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.inquilinos_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
  nome_completo TEXT NOT NULL,
  cpf TEXT,
...
CREATE TABLE IF NOT EXISTS public.moradores_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.veiculos_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.acessos_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.animais_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
  nome TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.vagas_garagem (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.ocorrencias_unidade (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  unidade_id UUID NOT NULL REFERENCES public.unidades(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_proprietarios_unidade_id ON public.proprietarios_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_inquilinos_unidade_id ON public.inquilinos_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_moradores_unidade_id ON public.moradores_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_veiculos_unidade_id ON public.veiculos_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_veiculos_placa ON public.veiculos_unidade(placa);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_documentos_unidade_id ON public.documentos_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_acessos_unidade_id ON public.acessos_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_visitantes_unidade_id ON public.visitantes_autorizados(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_animais_unidade_id ON public.animais_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_vagas_unidade_id ON public.vagas_garagem(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_ocorrencias_unidade_id ON public.ocorrencias_unidade(unidade_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_unidades_tipo ON public.unidades(tipo_unidade);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_unidades_situacao ON public.unidades(situacao);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_unidades_status_financeiro ON public.unidades(status_financeiro);-- Create a sequence for automatic unit codes
CREATE SEQUENCE IF NOT EXISTS IF NOT EXISTS public.unidades_codigo_seq START WITH 1 INCREMENT BY 1;
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.user_condominio_access (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.user_unidade_access (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS IF NOT EXISTS public.comunicados (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  condominio_id UUID NOT NULL REFERENCES condominios(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_comunicados_ativo ON public.comunicados(ativo) WHERE ativo = true;
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_contas_bancarias_administradora ON public.contas_bancarias(administradora_id) WHERE administradora_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_contas_bancarias_condominio ON public.contas_bancarias(condominio_id) WHERE condominio_id IS NOT NULL;
...
CREATE TABLE IF NOT EXISTS public.ocorrencias_condominio (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  condominio_id UUID NOT NULL REFERENCES public.condominios(id) ON DELETE CASCADE,
...
-- Índices para performance
CREATE INDEX IF NOT EXISTS idx_ocorrencias_condominio_condominio_id ON public.ocorrencias_condominio(condominio_id);
CREATE INDEX IF NOT EXISTS idx_ocorrencias_condominio_tipo ON public.ocorrencias_condominio(tipo_ocorrencia);
CREATE INDEX IF NOT EXISTS idx_ocorrencias_condominio_status ON public.ocorrencias_condominio(status);
CREATE INDEX IF NOT EXISTS idx_ocorrencias_condominio_data ON public.ocorrencias_condominio(data_ocorrencia DESC);
CREATE INDEX IF NOT EXISTS idx_ocorrencias_condominio_prioridade ON public.ocorrencias_condominio(prioridade);
...
CREATE TABLE IF NOT EXISTS public.categorias_demanda (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  nome text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.templates_demanda (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.demandas_condominio (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  condominio_id uuid NOT NULL REFERENCES public.condominios(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.execucoes_demanda (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.configuracoes_demanda (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Criar índices para performance
CREATE INDEX IF NOT EXISTS idx_demandas_condominio_id ON public.demandas_condominio(condominio_id);
CREATE INDEX IF NOT EXISTS idx_demandas_status ON public.demandas_condominio(status);
CREATE INDEX IF NOT EXISTS idx_demandas_proxima_execucao ON public.demandas_condominio(proxima_execucao);
CREATE INDEX IF NOT EXISTS idx_execucoes_demanda_id ON public.execucoes_demanda(demanda_id);
CREATE INDEX IF NOT EXISTS idx_templates_categoria_id ON public.templates_demanda(categoria_id);
...
CREATE TYPE IF NOT EXISTS public.tipo_valor_servico AS ENUM ('fixo', 'percentual', 'variavel');
...
CREATE INDEX IF NOT EXISTS idx_servicos_nome ON public.servicos(nome_servico);
CREATE INDEX IF NOT EXISTS idx_servicos_ativo ON public.servicos(ativo);
CREATE INDEX IF NOT EXISTS idx_servicos_historico_servico ON public.servicos_historico(servico_id);
...
CREATE TYPE IF NOT EXISTS proposta_status AS ENUM ('rascunho', 'enviada', 'em_analise', 'aprovada', 'recusada', 'expirada');

-- Enum para tipo de condomínio
CREATE TYPE IF NOT EXISTS condominio_tipo AS ENUM ('residencial', 'comercial', 'misto');

-- Enum para tipo de pacote
CREATE TYPE IF NOT EXISTS pacote_tipo AS ENUM ('basico', 'intermediario', 'completo', 'personalizado');

-- Enum para modelo de cobrança
CREATE TYPE IF NOT EXISTS cobranca_modelo AS ENUM ('por_unidade', 'valor_minimo', 'percentual', 'fixo_mensal', 'misto');

-- Enum para tipo de assinante
CREATE TYPE IF NOT EXISTS tipo_assinante AS ENUM ('sindico', 'administradora', 'testemunha');
...
CREATE TABLE IF NOT EXISTS public.proposta_assinaturas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  proposta_id UUID NOT NULL REFERENCES public.propostas(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_propostas_condominio ON public.propostas(condominio_nome);
CREATE INDEX IF NOT EXISTS idx_propostas_data_emissao ON public.propostas(data_emissao);
CREATE INDEX IF NOT EXISTS idx_propostas_criado_por ON public.propostas(criado_por);
CREATE INDEX IF NOT EXISTS idx_proposta_servicos_proposta ON public.proposta_servicos(proposta_id);
CREATE INDEX IF NOT EXISTS idx_proposta_servicos_servico ON public.proposta_servicos(servico_id);
...
CREATE TYPE IF NOT EXISTS public.acordo_status AS ENUM (
  'em_negociacao', 
  'ativo', 
  'quitado', 
  'rompido', 
...
CREATE TYPE IF NOT EXISTS public.acordo_parcela_status AS ENUM (
  'pendente', 
  'paga', 
  'atrasada', 
  'cancelada'
...
CREATE TYPE IF NOT EXISTS public.acordo_forma_pagamento AS ENUM (
  'avista', 
  'parcelado'
);

-- Enum para método de pagamento
CREATE TYPE IF NOT EXISTS public.acordo_metodo_pagamento AS ENUM (
  'boleto', 
  'pix', 
  'cartao', 
  'debito_automatico', 
...
CREATE TYPE IF NOT EXISTS public.acordo_tipo_acao AS ENUM (
  'criacao', 
  'edicao', 
  'assinatura', 
  'pagamento_parcela', 
...
CREATE TYPE IF NOT EXISTS public.acordo_tipo_alerta AS ENUM (
  'vencimento_proximo', 
  'parcela_vencida', 
  'risco_rompimento',
  'acao_agendada', 
...
CREATE TYPE IF NOT EXISTS public.acordo_prioridade AS ENUM (
  'baixa', 
  'media', 
  'alta', 
  'critica'
...
-- ====================================
CREATE TABLE IF NOT EXISTS public.acordo_parcelas_origem (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ====================================
CREATE TABLE IF NOT EXISTS public.acordo_parcelas_negociadas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  acordo_id UUID NOT NULL REFERENCES public.acordos(id) ON DELETE CASCADE,
...
-- ====================================
CREATE TABLE IF NOT EXISTS public.acordo_historico (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  acordo_id UUID NOT NULL REFERENCES public.acordos(id) ON DELETE CASCADE,
  usuario_id UUID REFERENCES auth.users(id),
...
-- ====================================
CREATE TABLE IF NOT EXISTS public.acordo_alertas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  acordo_id UUID NOT NULL REFERENCES public.acordos(id) ON DELETE CASCADE,
...
-- ÍNDICES
-- ====================================
CREATE INDEX IF NOT EXISTS idx_acordos_numero ON public.acordos(numero_acordo);
CREATE INDEX IF NOT EXISTS idx_acordos_unidade ON public.acordos(unidade_id);
CREATE INDEX IF NOT EXISTS idx_acordos_condominio ON public.acordos(condominio_id);
CREATE INDEX IF NOT EXISTS idx_acordos_status ON public.acordos(status);
CREATE INDEX IF NOT EXISTS idx_acordos_data_criacao ON public.acordos(data_criacao);
CREATE INDEX IF NOT EXISTS idx_acordos_responsavel ON public.acordos(responsavel_acompanhamento_id);

CREATE INDEX IF NOT EXISTS idx_acordo_parcelas_origem_acordo ON public.acordo_parcelas_origem(acordo_id);
CREATE INDEX IF NOT EXISTS idx_acordo_parcelas_negociadas_acordo ON public.acordo_parcelas_negociadas(acordo_id);
CREATE INDEX IF NOT EXISTS idx_acordo_parcelas_negociadas_vencimento ON public.acordo_parcelas_negociadas(data_vencimento);
CREATE INDEX IF NOT EXISTS idx_acordo_parcelas_negociadas_status ON public.acordo_parcelas_negociadas(status);

CREATE INDEX IF NOT EXISTS idx_acordo_historico_acordo ON public.acordo_historico(acordo_id);
CREATE INDEX IF NOT EXISTS idx_acordo_historico_tipo ON public.acordo_historico(tipo_acao);

CREATE INDEX IF NOT EXISTS idx_acordo_alertas_acordo ON public.acordo_alertas(acordo_id);
CREATE INDEX IF NOT EXISTS idx_acordo_alertas_enviado ON public.acordo_alertas(enviado);
CREATE INDEX IF NOT EXISTS idx_acordo_alertas_prioridade ON public.acordo_alertas(prioridade);
...
CREATE TYPE IF NOT EXISTS public.reserva_status AS ENUM ('pendente', 'confirmada', 'cancelada', 'concluida', 'recusada');

-- Enum de status de acesso de convidado
CREATE TYPE IF NOT EXISTS public.convidado_status_acesso AS ENUM ('liberado', 'bloqueado', 'pendente');
...
CREATE INDEX IF NOT EXISTS idx_reservas_data_inicio ON public.reservas(data_inicio);
CREATE INDEX IF NOT EXISTS idx_reservas_area_status ON public.reservas(area_comum_id, status);
...
CREATE TABLE IF NOT EXISTS public.reserva_convidados (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_reserva_convidados_reserva ON public.reserva_convidados(reserva_id);
...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_atendimentos_condominio ON public.atendimentos(condominio_id);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_atendimentos_status ON public.atendimentos(status);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_atendimentos_data ON public.atendimentos(created_at DESC);

-- 2. Boletos: Composite index para performance em listagens financeiras
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_boletos_status_vencimento ON public.boletos(status, data_vencimento);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_boletos_nosso_numero ON public.boletos(nosso_numero);

-- 3. Transações Financeiras: Busca por período e tipo
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_transacoes_data ON public.transacoes_financeiras(data_vencimento DESC);
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_transacoes_tipo ON public.transacoes_financeiras(tipo);

-- 4. Audit Logs: Filtro por entidade
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_audit_logs_entity_type ON public.audit_logs(entity_type);

-- 5. Unidades: Busca por bloco e código
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_unidades_bloco_codigo ON public.unidades(condominio_id, bloco, codigo);

-- 6. Moradores: Busca por CPF
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_moradores_cpf ON public.moradores_unidade(cpf);
-- =====================================================
...
CREATE TABLE IF NOT EXISTS mensageria_logs (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS morador_preferencias_notificacao (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_mensageria_entregas_condominio ON mensageria_entregas(condominio_id);
CREATE INDEX IF NOT EXISTS idx_mensageria_entregas_status ON mensageria_entregas(status);
CREATE INDEX IF NOT EXISTS idx_mensageria_entregas_destinatario ON mensageria_entregas(destinatario_id);
CREATE INDEX IF NOT EXISTS idx_mensageria_entregas_criado_em ON mensageria_entregas(criado_em DESC);
CREATE INDEX IF NOT EXISTS idx_mensageria_entregas_comunicado ON mensageria_entregas(comunicado_id);
CREATE INDEX IF NOT EXISTS idx_mensageria_logs_entrega ON mensageria_logs(entrega_id);
